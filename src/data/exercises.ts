  ...
  // ─── 3. Inner Child Work ─────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        type: 'timed-pause',
        id: 'ic-visualization',
        label: 'Visualization — meet your younger self',
        durationSeconds: 120,
      },
      {
        type: 'instruction',
        id: 'ic-viz-guide',
        title: 'During the pause above, try this:',
        body: 'Close your eyes. Imagine walking into a space where you see yourself at that age. Notice what the child looks like. Notice their expression.\n\nSlowly approach them. Let them see you. Ask silently: "What do you need? What did you never get to say?"\n\nJust listen. Don\'t fix anything yet.',
      },
      {
        type: 'prompt',
        id: 'ic-what-needed',
