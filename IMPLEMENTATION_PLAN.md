...
- [ ] Create src/data/prompts.ts with 4 pool categories (projection, childhood, self-examination, integration) populated from research.md (spec: phase-3-journal.md)
...
- [ ] Create src/data/safety.ts with safety disclaimers and grounding techniques (5-4-3-2-1 sensory, breathing exercise) (spec: phase-5-specialized-exercises.md)
- [ ] Trigger Tracking enhancements: structured input form (situation, emotion, intensity, body location, shadow insight), store in triggerLogs, pattern analysis summary (spec: phase-5-specialized-exercises.md)
- [ ] Dream Work enhancements: DreamEntry storage in dreamEntries, figure tracking, emotion tagging, analysis notes, dream journal list view (spec: phase-5-specialized-exercises.md)
...
- [ ] Build Progress page: current streak + longest streak, total active days, exercise completion counts by type, most practiced type (spec: phase-7-progress.md)
- [ ] Build custom CalendarHeatmap component — activity density per day, ember red color scale, scrollable by month (spec: phase-7-progress.md)
- [ ] Add trigger analytics section: most common emotions, average intensity trend, most common body locations (shown only if trigger logs exist) (spec: phase-7-progress.md)
...
- [ ] Build Onboarding flow: 3-4 swipeable framer-motion cards (intro shadow work, what app does, privacy promise), "Begin" button sets onboardingComplete in userSettings; redirect first-launch to /onboarding (spec: phase-8-onboarding-polish.md)
